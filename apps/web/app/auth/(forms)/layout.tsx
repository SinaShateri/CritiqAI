...
const Layout = async ({ children }: LayoutProps<'/auth'>) => {
  return (
    <div
      className='bg-background text-foreground flex min-h-screen w-full items-center justify-center px-4 py-10'
      style={{
        backgroundImage:
    ...
    >
      <div
        className='animate-fade-up border-border bg-background flex w-full max-w-225 overflow-hidden rounded-xl border'
