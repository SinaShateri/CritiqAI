...
const Layout = async ({ children }: LayoutProps<'/auth'>) => {
  return (
    <div
      className='flex min-h-screen w-full items-center justify-center bg-background px-4 py-10 text-foreground'
      style={{
        backgroundImage:
    ...
    >
      <div
        className='animate-fade-up flex w-full max-w-225 overflow-hidden rounded-xl border border-border bg-background'
