  ...
  return (
    <section className='border-border-subtle border-b px-6 pt-18 pb-14 text-center'>
      <div className='mx-auto max-w-3xl'>
        <div className='border-border bg-surface-raised inline-flex items-center gap-2 rounded-full border px-3.5 py-1'>
          <span className='bg-brand h-1.5 w-1.5 rounded-full'></span>
          <span className='text-primary text-xs'>Everything you need</span>
        </div>
        <h1 className='text-foreground mt-6 text-[40px] leading-tight font-medium'>
          One tool. <span className='text-brand'>Six deep checks.</span> Zero
          guesswork.
        </h1>
        <p className='text-foreground-muted mx-auto mt-3.5 max-w-130 text-base leading-[1.7]'>
