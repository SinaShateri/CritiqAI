    ...
    <>
      ...
      <section className='border-border-subtle border-b px-6 py-14'>
        <div className='mx-auto max-w-240'>
          <SectionHeader eyebrow='Core features' title='What CritiqAI checks' titleClassName='text-2xl font-medium' />
          <div id='feature-results' role='tabpanel' aria-label='Feature results' className='mt-7 grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-3'>
